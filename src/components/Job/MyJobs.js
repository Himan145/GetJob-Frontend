...
export const MyJobs=()=>{
    ...
    const handleUpdateJob=async(jobId)=>{
        ...
        await axios.put(`http://localhost:5000/api/v1/job/update/${jobId}`,updatedJob,{withCredentials:true})
        .then((res)=>{
    ...
    const handleDeleteJob=async(jobId)=>{
        await axios.delete(`http://localhost:5000/api/v1/job/delete/${jobId}`,{withCredentials:true})
        .then((res)=>{
            toast.success(res.data.message);
